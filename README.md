...
<!-- If you modify this example, please also update it's copy in lib.rs -->
...
<img alt="Ferris" src="./tests/img/ferris.png" height=280>

Our subimage:

<img alt="A crop of ferris' eyes" src="./tests/img/ferris_eyes.png" height=60>

The best match:

<img alt="Ferris again but with a red rectangle over their eyes" src="./tests/img/ferris_eyes_matched.png" height=280>
